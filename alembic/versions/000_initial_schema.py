...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('category', sa.Enum('food', 'transport', 'entertainment', 'education', 'salary', 'other', name='transactioncategory'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('risk_level', sa.Enum('safe', 'warning', 'danger', 'critical', name='risklevel'), nullable=True),
    ...
    op.create_index(op.f('ix_predictions_is_active'), 'predictions', ['is_active'], unique=False)
    ...
    op.create_index(op.f('ix_daily_missions_date'), 'daily_missions', ['date'], unique=False)
    ...
    op.create_index(op.f('ix_user_market_responses_event_id'), 'user_market_responses', ['event_id'], unique=False)
    op.create_index(op.f('ix_user_market_responses_id'), 'user_market_responses', ['id'], unique=False)
    op.create_index(op.f('ix_user_market_responses_user_id'), 'user_market_responses', ['user_id'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=True),
        sa.Column('mastery_scores', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index(op.f('ix_adaptive_profiles_user_id'), 'adaptive_profiles', ['user_id'], unique=True)
    ...
    op.create_index(op.f('ix_adaptive_answers_created_at'), 'adaptive_answers', ['created_at'], unique=False)
    op.create_index(op.f('ix_adaptive_answers_id'), 'adaptive_answers', ['id'], unique=False)
    op.create_index(op.f('ix_adaptive_answers_topic'), 'adaptive_answers', ['topic'], unique=False)
    op.create_index(op.f('ix_adaptive_answers_user_id'), 'adaptive_answers', ['user_id'], unique=False)
