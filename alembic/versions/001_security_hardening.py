...
def upgrade():
    ...
    op.create_index('idx_audit_user_action_time', 'audit_logs', ['user_id', 'action', 'timestamp'])
    ...
    # Portfolios table
    op.create_check_constraint(
        'check_shares_positive',
        'portfolios',
        'shares > 0'
    )

    op.create_check_constraint(
        'check_avg_price_positive',
        'portfolios',
        'avg_price > 0'
    )
    ...
    # Achievements table
    op.create_check_constraint(
        'check_achievement_xp_non_negative',
        'achievements',
        'xp_reward >= 0'
    )
    ...
    op.create_check_constraint(
        'check_response_xp_non_negative',
