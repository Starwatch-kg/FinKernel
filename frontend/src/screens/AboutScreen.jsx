  ...
  const sections = [
    {
      id: "what",
      icon: "🎯",
      title: "Что такое FinFuture?",
      text: "FinFuture — это умный финансовый ассистент для зумеров. Здесь ты учишься управлять личными финансами, контролировать траты и планировать бюджет. Добавляй транзакции, получай советы от AI и достигай финансовых целей.",
    },
    {
      id: "how",
      icon: "📊",
      title: "Как работает приложение?",
      text: "Ты добавляешь свои доходы и расходы, выбираешь категории (еда, транспорт, развлечения). FinFuture анализирует твои траты и показывает, на что уходит больше всего денег. AI-советник подсказывает, как оптимизировать расходы и не тратить лишнего.",
    },
    {
      id: "transactions",
      icon: "💰",
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        ...
        <p style={s.subtitle}>Всё, что нужно знать о FinFuture</p>
      </div>
      ...
      <div style={s.footer}>
        <p style={s.footerText}>FinFuture — умный финансовый ассистент. Управляй деньгами осознанно!</p>
      </div>
    </div>
  )
}
